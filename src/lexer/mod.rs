...
impl Tokenizer{
    ...
    fn tokenize_single_part(&mut self) -> E::Result<bool>{
        match self.first()?{
            '+' => self.tokens.push_new_operation(OperationType::Add,TokenType::BinaryOp),
            '-' => self.tokens.push_new_operation(OperationType::Subtract,TokenType::BinaryOp),
            '*' => self.tokens.push_new_operation(OperationType::Multiply,TokenType::BinaryOp),
            '/' => self.tokens.push_new_operation(OperationType::Divide,TokenType::BinaryOp),
            '=' => self.tokens.push_new_token(TokenType::Assign),
            '>' => self.tokens.push_new_operation(OperationType::Greater,TokenType::BinaryComp),
            '<' => self.tokens.push_new_operation(OperationType::Less,TokenType::BinaryComp),
            _ => {return Ok(false)}
        }
        self.src.consume();
        return Ok(true);
    ...
    fn tokenize_double_char(&mut self) -> E::Result<bool>{
        ...
        match self.src.peak(1){
            None => {return self.tokenize_single_part();}
        ...
        match str.as_str(){
            ...
            "**" => self.tokens.push_new_operation(OperationType::Power, TokenType::BinaryOp),
            ">=" => self.tokens.push_new_operation(OperationType::GreaterEq, TokenType::BinaryComp),
            "<=" => self.tokens.push_new_operation(OperationType::LessEq, TokenType::BinaryComp),
            "!=" => self.tokens.push_new_operation(OperationType::NotEq, TokenType::BinaryComp),
            "==" => self.tokens.push_new_operation(OperationType::Eq, TokenType::BinaryComp),
    ...
    fn tokenize_word(&mut self) -> E::Result<()>{
        ...
        match word.as_str(){
            ...
            "and" => self.tokens.push_new_operation(OperationType::And,TokenType::BinaryComp),
            "or" => self.tokens.push_new_operation(OperationType::Or,TokenType::BinaryComp),
            "not" => self.tokens.push_new_operation(OperationType::Not,TokenType::BinaryComp),
